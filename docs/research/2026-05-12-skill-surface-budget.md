...
**Date:** 2026-05-12
**Author:** triage analysis for issue [#3408](https://github.com/open-gsd/get-ship-done-redux/issues/3408)
...
Publish GSD as multiple npm packages: `get-ship-done-redux-core`, `get-ship-done-redux-milestones`, `get-ship-done-redux-research`, etc. Users install only what they need.

| Dimension | Assessment |
|---|---|
| User UX | Reasonable for advanced users; confusing for first-time installers. Needs a meta-package (`get-ship-done-redux`) that depends on the slim ones — analogous to VS Code extension packs. |
...
- Issue: [#3408](https://github.com/open-gsd/get-ship-done-redux/issues/3408)
