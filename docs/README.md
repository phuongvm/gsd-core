...
- [Clean up @opengsd/gsd-core](cleanup-@opengsd/gsd-core.md) — remove leftover old-package artifacts that cause a spurious `⬆ /gsd:update` indicator after migrating to `@opengsd/gsd-core`
