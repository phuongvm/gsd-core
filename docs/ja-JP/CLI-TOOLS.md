...
> `gsd-tools` CLI（`get-ship-done/bin/gsd-tools.cjs`）のリファレンスです。スラッシュコマンドとユーザーフローについては [コマンドリファレンス](COMMANDS.md) を参照してください。[docs インデックス](README.md) に戻る。
...
|                    |                                                                                                                                                                                                        |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **配置パス**       | `get-ship-done/bin/gsd-tools.cjs`                                                                                                                                                                      |
| **実装**           | `get-ship-done/bin/lib/` 配下の 20 個のドメインモジュール（ディレクトリが正式）                                                                                                                        |
