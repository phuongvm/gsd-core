...
| ワークフロー: new-workspace | `get-ship-done/workflows/new-workspace.md` |
| ワークフロー: list-workspaces | `get-ship-done/workflows/list-workspaces.md` |
| ワークフロー: remove-workspace | `get-ship-done/workflows/remove-workspace.md` |
| Init 関数 | `get-ship-done/bin/lib/init.cjs`（`cmdInitNewWorkspace`、`cmdInitListWorkspaces`、`cmdInitRemoveWorkspace` を追加） |
| ルーティング | `get-ship-done/bin/gsd-tools.cjs`（init switch にケースを追加） |
